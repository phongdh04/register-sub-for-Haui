...
const adminNav = [
  ...
  { to: '/admin/lichdangkyhockyconfig', label: 'Lịch đăng ký HK', icon: 'schedule' },
  { to: '/admin/setupcuhnhgivngtrafficsplittingqueuecontrol', label: 'Solver scheduling', icon: 'hub' },
